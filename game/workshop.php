...
$units = unit_catalog_by_building($tribe, 'workshop');
...
<div class="page">
  <div class="shell">
    ...
    <div class="panel">
      ...
      <div class="list">
        <?php if (!$units): ?>
          <div class="listRow"><div class="listMain"><span class="rowIcon">ℹ️</span><span class="listTitle">Kol kas dirbtuvių vienetų nėra.</span></div></div>
        <?php endif; ?>
        ...
        <?php foreach ($units as $key=>$u): $isR = (bool)($researched[$key] ?? false); ?>
          <form method="post" action="train.php" class="listRow" style="gap:10px; align-items:center;">
            ...
            <input type="hidden" name="building_type" value="workshop">
            <div class="listMain">
